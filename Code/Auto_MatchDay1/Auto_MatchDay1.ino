...
int proportional, high_speed0 = 55, high_speed1 = 70, high_speed = 20, low_speed = 25, KP = 70, pwm;
int weight_index;
int jc = 0, a = 0, qq = 0;
int stablede = 1200;
int stable1 = 1000;
...
void loop() {
  ...
  if ((mpuIntStatus & 0x10) || fifoCount == 1024) {
    ...
    if (stable < 0) {
      ...
      Serial.println();
      if ( digitalRead(37)||digitalRead(35)==LOW)
      {if (digitalRead(34)==LOW && jc==3)
     {
        jc = jc + 1;
      }
...
Serial.println("xxxxxxxxxxxx");
  delay(200);
          ...
          if((v<2 && tz==1) || (v<2 && tz==2) || (v<2 && tz==3) )
          {
          jc=2;
          high_speed=20;
          Back();
          Serial.println("ttttzzzzzzzzzzz22222222222222222");
          }
          else if (tz==1 && v>=2)
          {high_speed=20;
            jc=0;
          ...
          Serial.println("ttttttttttttzzzzzzzzz33333333333333333");
          high_speed=20;
            jc=2;
            tz=3;
            v=0;
 ...
 /* Backward(50,50,50,50);
  ...
  delay(200);*/
              ...
              { 
                ...
                analogWrite(backLeftpwm, 0);
                analogWrite(backRightpwm, 0);
                Serial.print("tzzzzzz3333333333");
                delay(1000);
                high_speed0=32;
                Serial.print("\nDown PWM:&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&77");
               high_speed=20;
...
while (true)
  ...
  while (true)
  {
...

    {
      ...
      Serial.println(jc);
      Serial.println("BAALLLLLLLLLL_NUMBERRRRR");
/*
